...
function grip_scripts()
{
    ...
    $grip_font_url   = $grip_theme_options['grip-font-family-url'] ? esc_url( $grip_theme_options['grip-font-family-url'] ) : esc_url('//fonts.googleapis.com/css?family=Roboto:300', 'grip');
    wp_enqueue_style('grip-header-font', '//fonts.googleapis.com/css?family=Domine');
    wp_enqueue_style('grip-body-font', $grip_font_url);
